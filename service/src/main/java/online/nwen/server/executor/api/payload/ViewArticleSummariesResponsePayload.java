...
public class ViewArticleSummariesResponsePayload {
    ...
    private Set<ArticleSummary> summaries;

    public ViewArticleSummariesResponsePayload() {
        this.summaries = new HashSet<>();
    }

    public Set<ArticleSummary> getSummaries() {
        return summaries;
    }
}
