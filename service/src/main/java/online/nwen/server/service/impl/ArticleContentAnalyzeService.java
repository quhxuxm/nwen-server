...
@Service
class ArticleContentAnalyzeService implements IArticleContentAnalyzeService {
    private static final Logger logger = LoggerFactory.getLogger(ArticleContentAnalyzeService.class);
    private static final String IMG_TAG = "img";
    private static final String VIDEO_TAG = "video";
    private static final String AUDIO_TAG = "audio";

    @Override
    public ArticleContentAnalyzeResponse analyze(ArticleContentAnalyzeRequest request) {
        ArticleContentAnalyzeResponse result = new ArticleContentAnalyzeResponse();
        Document cleanDocument = Jsoup.parse(Jsoup.clean(request.getContent(), this.createWhiteList()));
    ...
    private void parseMediaContent(Document document, String tagName,
        ...
        imgElements.forEach(element -> {
            ...
            ArticleContentAnalyzeResponse.MediaContent mediaContent = new ArticleContentAnalyzeResponse.MediaContent();
